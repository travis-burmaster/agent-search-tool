...
from agent_search.channels import get_all_channels, get_channel
from agent_search.channels.xiaohongshu import XiaoHongShuChannel
from agent_search.channels.xueqiu import XueqiuChannel
...
class TestXueqiuChannel:
    ...
    def test_check_ok_when_api_reachable(self, monkeypatch):
        import agent_search.channels.xueqiu as xueqiu_mod
    ...
    def test_ensure_cookies_loads_from_config(self, monkeypatch, tmp_path):
        ...
        import agent_search.channels.xueqiu as xq_mod
        monkeypatch.setattr(
            xq_mod,
