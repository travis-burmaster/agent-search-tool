...
```bash
curl -s "https://www.v2ex.com/api/topics/hot.json" -H "User-Agent: agent-search/1.0"
```
...
curl -s "https://www.v2ex.com/api/topics/show.json?node_name=python&page=1" -H "User-Agent: agent-search/1.0"
```
...
curl -s "https://www.v2ex.com/api/topics/show.json?id=TOPIC_ID" -H "User-Agent: agent-search/1.0"
```

### 主题回复

```bash
curl -s "https://www.v2ex.com/api/replies/show.json?topic_id=TOPIC_ID&page=1" -H "User-Agent: agent-search/1.0"
```

### 用户信息

```bash
curl -s "https://www.v2ex.com/api/members/show.json?username=USERNAME" -H "User-Agent: agent-search/1.0"
```

### Python 调用示例

```python
from agent_search.channels.v2ex import V2EXChannel
