...
```bash
# 输出 Markdown 文件到 /tmp/
~/.agent-search/tools/xiaoyuzhou/transcribe.sh "https://www.xiaoyuzhoufm.com/episode/EPISODE_ID"
```
...
3. **配置 Key**: `agent-search configure groq-key YOUR_KEY`
4. **首次运行**: `agent-search install --env=auto` 安装工具
